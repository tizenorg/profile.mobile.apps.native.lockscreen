...
static Evas_Object* _lockscreen_password_view_layout_create(Evas_Object *parent, const char *group_name)
{
	...
	Evas_Object *btn_cancel = elm_button_add(ly);
	elm_layout_theme_set(btn_cancel, "button", "panel", "default");
	elm_object_text_set(btn_cancel, _("IDS_ST_BUTTON_CANCEL"));
	evas_object_smart_callback_add(btn_cancel, "clicked", _lockscreen_password_view_cancel_button_clicked, ly);

	elm_object_part_content_set(ly, "sw.cancel", btn_cancel);

	Evas_Object *btn_return = elm_button_add(ly);
	...
	evas_object_smart_callback_add(btn_return, "clicked", _lockscreen_password_view_return_to_call_button_clicked, ly);

	elm_object_part_content_set(ly, "sw.return", btn_return);
