...
static void
_lockscreen_events_view_scroller_anim_stopped2(void *data, Evas *e, Evas_Object *eo, void *event_info)
{
	struct Events_View_Data *ed = data;
...
static void _lockscreen_events_view_scroller_hit_rectangle_add(Evas_Object *obj, struct Events_View_Data *data)
{
	...
	evas_object_event_callback_add(track, EVAS_CALLBACK_MOUSE_UP, _lockscreen_events_view_scroller_anim_stopped2, data);
...
Evas_Object *lockscreen_events_view_create(Evas_Object *parent)
{
	...
	elm_scroller_page_size_set(data->scroller, 720, 0);
...
static void
_lockscreen_events_view_page_add(struct Events_View_Data *data, Evas_Object *page, int append)
{
	Elm_Object_Item *idx;
...
Evas_Object *lockscreen_events_view_page_append(Evas_Object *events_view)
{
	...
	_lockscreen_events_view_page_add(data, page, 1);
	return page;
}
...
Evas_Object *lockscreen_events_view_page_prepend(Evas_Object *events_view)
{
	...
	_lockscreen_events_view_page_add(data, page, 0);
	return page;
}
