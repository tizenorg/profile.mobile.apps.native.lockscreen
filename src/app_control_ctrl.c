...
static Eina_Bool
_lockscreen_app_control_device_lock_unlocked(void *data, int event, void *event_info)
{
...
int lockscreen_app_control_ctrl_init(void)
{
	...
	handler = ecore_event_handler_add(LOCKSCREEN_EVENT_DEVICE_LOCK_UNLOCKED, _lockscreen_app_control_device_lock_unlocked, NULL);
