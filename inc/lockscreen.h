 ...
 * if (!notification) {
 * 	fprintf(stderr, "notification_create FAIL\n");
 * 	...
 * }
 *
 ...
 * 	fprintf(stderr, "notification_set_display_applist FAIL\n");
 * 	...
 * }
 * ...
 *
 ...
 *
 * Lock type is set by changing VCONFKEY_SETAPPL_SCREEN_LOCK_TYPE_INT value. There are few options:
